...
const CreateDealer = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const dealerFee = e.target.dealerFee.value;
    ...
    const formData = {
      ...
      organizerFee,dealerFee, registrationFee, idCardFee, serviceFee, totalAmount,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                id="dealerFee"
                name="dealerFee"
                value={selectedMemberType === "Dealer" ? 30000 : 0}
                readOnly
                className={`w-full px-4 py-2 border rounded-md ${errors.dealerFee ? "border-red-400" : "border-gray-700"} bg-gray-100 text-gray-800 focus:border-violet-400 focus:outline-none`}
              />
            </div>
