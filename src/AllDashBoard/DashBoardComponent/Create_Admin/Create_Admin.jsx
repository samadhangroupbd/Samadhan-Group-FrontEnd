  ...
  return (
    <div className="flex justify-center  items-center min-h-screen ">
      <div className="w-full max-w-5xl p-8 my-10 rounded-lg shadow-lg bg-gray-100 text-gray-800">
        <h2 className="mb-4 text-3xl font-semibold text-center text-gray-800">Create Admin Account</h2>

        {/* Display General Error */}
        {errors.general && (
          // <div className="mb-4 text-red-400 text-center">{errors.general}</div>
          <div className="mb-4 text-red-400 text-center"><span className="font-bold">Create Admin Successfully....</span></div>
        )}
        ...
        <form onSubmit={handleSubmit} className=" space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-2">
              <label htmlFor="member" className="block text-sm text-gray-800">Admin Type</label>
              <select
                id="member"
                name="member"
